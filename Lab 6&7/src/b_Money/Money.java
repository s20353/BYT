...
public class Money implements Comparable
{
	...
	{
		int sum = Math.addExact(this.amount, currency.valueInThisCurrency(other.getAmount(), other.getCurrency()));
	...
	{
		int diff = Math.subtractExact(this.amount, currency.valueInThisCurrency(other.getAmount(), other.getCurrency()));
	...
	public int compareTo(Object other)
	{
		...
		if (universalValue() < otherMoney.universalValue())
		{
			return -1;
		}
